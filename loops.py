...
print(f"The average gain/loss per day is {average_gain_loss_per_day}")
...
sum_dict = 0.00
for portfolio_gain_loss in portfolio_gain_loss_dict:
    if portfolio_gain_loss_dict[portfolio_gain_loss] >= 0:
        sum_dict += portfolio_gain_loss_dict[portfolio_gain_loss]
    else:
        sum_dict -= portfolio_gain_loss_dict[portfolio_gain_loss]
print(sum_dict)
...
for portfolio_gain_loss in portfolio_gain_loss_dict:
    if portfolio_gain_loss_dict[portfolio_gain_loss] >= 1000:
        big_gains.append(portfolio_gain_loss_dict[portfolio_gain_loss])
    elif portfolio_gain_loss_dict[portfolio_gain_loss] <= -1000:
        big_losses.append(portfolio_gain_loss_dict[portfolio_gain_loss])
print(big_gains)
print(big_losses)
