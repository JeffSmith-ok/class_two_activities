...
know_for = "First Computer Programmer"
...
statement_one = f"{first_name} {last_name} is a British {profession} born in {birth_year}"
print(statement_one)
...
statement_two = f"She s commonly referred to as a {profession}"
print(statement_two)
...
statement_four = f"She was a {nationality} Citizen who lived in {city_location}, {country_location} until her passing in {death_year} at the age of {death_year - birth_year}."
